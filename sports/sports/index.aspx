<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="sports.index" %>
...
<!-- Topbar End -->
    ...
    <div class="row px-xl-5 pb-3">
              <asp:Repeater ID="cate" runat="server">
                  <ItemTemplate>  
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                  ...
                  <%--  <a href="product2.php?id=<?php echo $res['id'];?>" class="cat-img position-relative overflow-hidden mb-3">--%>
                      <a href='<%# Eval("id", "catproduct.aspx?id={0}") %>'><img class="img-fluid" src="catimage/<%# Eval("image") %>" alt="" style="height: 500px; width:600px;"></a>
                    <%--</a>--%>
                    <h5 class="font-weight-semi-bold m-0"> <%# Eval("name") %> </h5>
                    </div>
                       </div>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">BRANDS</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
           
           
                  <asp:Repeater ID="bran" runat="server">
                  <ItemTemplate> 
                       <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                   <a href='<%# Eval("id", "brandproduct.aspx?id={0}") %>'><img class="img-fluid w-100" src="brandimage/<%# Eval("image") %>" alt="" style="height: 500px; width:600px;"></a>
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3"><%# Eval("name") %><br></h6>
                    </div>
                ...
                <asp:Repeater ID="brand" runat="server">
                  <ItemTemplate>  
                    <div class="vendor-item border p-4">
                        ...
                        <img src="brandimage/<%# Eval("image") %>" style="height: 220px;">
