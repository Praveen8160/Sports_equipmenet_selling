<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcat.aspx.cs" Inherits="sports.addcat" %>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                          <%--  <button type="submit" class="btn btn-primary" name="submit">ADD CATEGORIES</button>--%>
                                            <asp:Button ID="upload1" class="btn btn-primary" runat="server" Text="ADD CATEGORIES" OnClick="upload1_Click"/>
                                        </div>
                                    </div>
