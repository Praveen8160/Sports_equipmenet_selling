<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewcustomer.aspx.cs" Inherits="sports.viewcustomer" %>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                  ...
                  <asp:GridView class="table" ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="id" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing1">
                    <Columns>
