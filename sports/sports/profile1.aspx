<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile1.aspx.cs" Inherits="sports.profile1" %>
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <!-- <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle"> -->
                <h1><% Response.Write(Session["name1"]); %></h1>
            ...
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                    ...
                    <asp:Button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview" ID="overview" runat="server" Text="Overview" />
                </li>

                <li class="nav-item">              
                    <asp:Button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" ID="edit" runat="server" Text="Edit Profile" OnClick="edit_Click"/>
                </li>


                <li class="nav-item">
                  
                    <asp:Button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password" ID="changepass" runat="server" Text="Change Password" OnClick="changepass_Click"/>
                </li>

                
                <li class="nav-item">
                  
                    <asp:Button class="nav-link" data-bs-toggle="tab" data-bs-target="#order" ID="order" runat="server" Text="Order" OnClick="order_Click"/>
              ...
              <div class="tab-content pt-2">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["name1"]); %></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">address</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["add2"]); %></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Gender</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["g"]); %></div>
                  </div>
                
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">city</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["city2"]); %></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">state</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["state2"]); %></div>
                  </div>


                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">pincode</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["pin2"]); %></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["email2"]); %></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8"><% Response.Write(Session["phone"]); %></div>
                  </div>
                </div>
