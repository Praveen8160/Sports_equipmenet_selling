<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addbrand.aspx.cs" Inherits="sports.addbrand" %>
                                 ...
                                 <form id="form1" runat="server">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <asp:Button ID="upload" class="btn btn-primary" runat="server" Text="ADD BRAND" OnClick="upload_Click"/>
                                        </div>
                                    </div>
