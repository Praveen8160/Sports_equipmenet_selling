<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="sports.edit" %>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h1><% Response.Write(username.Text); %></h1>
            ...
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                    ...
                    <asp:Button ID="edit1" class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-edit" runat="server" Text="Edit Profile" />
                </li>
                ...
                <li class="nav-item">
                    ...
                    <asp:Button ID="orderview" class="nav-link" data-bs-toggle="tab" data-bs-target="#order" runat="server" Text="Order" OnClick="orderview_Click" />
                </li>
                  ...
                  <!-- Profile Edit Form -->
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                          ...
                          <asp:TextBox ID="state" class="form-control" runat="server" placeholder="state"></asp:TextBox>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                          ...
                          <asp:TextBox ID="pincode" class="form-control" runat="server" TextMode="Number" placeholder="pincode"></asp:TextBox>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                          ...
                          <asp:TextBox ID="phone" class="form-control" runat="server" TextMode="Number" placeholder="Phone"></asp:TextBox>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <asp:TextBox ID="email" class="form-control" runat="server" placeholder="email" ReadOnly="True"></asp:TextBox>
                      </div>
                    </div>

                    <div class="text-center">
                    
                        <asp:Button ID="save" class="btn btn-primary" runat="server" Text="Save Changes" OnClick="save_Click" />
                    </div>
