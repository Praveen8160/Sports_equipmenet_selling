<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewproduct.aspx.cs" Inherits="sports.viewproduct" %>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" DataKeyNames="id" Width="1474px">
            <Columns>
         ...
         <asp:BoundField DataField="offer" HeaderText="Offer" />
                ...
                <asp:BoundField DataField="quantity" HeaderText="Quantity" />
                 ...
                 <asp:TemplateField HeaderText="Image">
                    ...
                    <ItemTemplate>
                        <img src="productimage/<%#Eval("image") %>" height="120"/>
                    </ItemTemplate>
                    </asp:TemplateField>

                <%--<asp:CommandField ButtonType="Button" ShowEditButton="True">
                <ControlStyle BackColor="#666666" ForeColor="White" />
