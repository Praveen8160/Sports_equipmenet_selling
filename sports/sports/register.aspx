                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                          <%--  <a href="index.php" class="nav-item nav-link">Home</a>--%>
                             <asp:HyperLink ID="HyperLink3" class="nav-item nav-link" runat="server" NavigateUrl="~/index.aspx">Home</asp:HyperLink>
	...
	<div class="container">
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
					<asp:TextBox ID="username" class="input100" runat="server" placeholder="username"></asp:TextBox>
					<asp:RequiredFieldValidator ID="username1" runat="server" ErrorMessage="username is required" Display="Dynamic" Text="username is required" ControlToValidate="username" SetFocusOnError="True" ForeColor="#CC66FF"></asp:RequiredFieldValidator>
					
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
					<asp:TextBox ID="email" TextMode="Email" class="input100"  runat="server" placeholder="email" ControlToValidate="email"></asp:TextBox>
					<asp:RegularExpressionValidator ID="emailvalidate" runat="server" ErrorMessage="email are not correct" ForeColor="#FF66FF" Display="Dynamic" Text="email are not correct" SetFocusOnError="True" ControlToValidate="email" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="container-login100-form-btn">
					<asp:Button runat="server" class="login100-form-btn" Id="btnregister" Text="sign up" name="register_user" OnClick="btnregister_Click"></asp:Button>
                                  
			
				</div>
				<div class="text-center">already account?
                                    <a href="login1.aspx" class="txt2 hov1">
...
<!--===============================================================================================-->
    ...
    <!-- Back to Top -->
      <a href="#" class="btn btn-colo back-to-top"><i class="fa fa-angle-double-up"></i></a>
