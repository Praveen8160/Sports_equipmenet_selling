<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vieworder.aspx.cs" Inherits="sports.vieworder" %>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                ...
                <asp:GridView class="table" ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" OnRowUpdating="GridView1_RowUpdating" OnRowEditing="GridView1_RowEditing" DataKeyNames="id" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting">
                    <Columns>
