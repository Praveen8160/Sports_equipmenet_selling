<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateproduct.aspx.cs" Inherits="sports.updateproduct" %>
                                ...
                                <form id="form2" runat="server">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <asp:TextBox ID="pname" class="form-control" runat="server" placeholder="enter product name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <asp:TextBox ID="price" class="form-control" runat="server" TextMode="Number" value="0" placeholder="enter product price"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                           <%-- <input type="text" class="form-control" name="offer">--%>
                                            <asp:TextBox ID="offer" class="form-control" runat="server" TextMode="Number" value="0" placeholder="enter product offer"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    ?>
                                            ...
                                            <asp:DropDownList ID="pbrand" class="form-control" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:DropDownList ID="pcat" class="form-control" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="psize" class="form-control" runat="server"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-3">
                                        <a href="size.aspx" ><button type="button" class="btn btn-primary" name="addimage">ADD SIZE</button></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <asp:TextBox ID="description" class="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                           <%-- <input type="text" class="form-control" name="qty">--%>
                                            <asp:TextBox ID="quantity" class="form-control" runat="server" value="0" TextMode="Number"></asp:TextBox>
                                        </div>
                                    </div>
                                    <!-- <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10"  id="image_box">
                                            ...
                                            <asp:FileUpload ID="image" class="form-control" runat="server" />
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <asp:Button ID="addpro" class="btn btn-primary" runat="server" Text="ADD PRODUCT" OnClick="addpro_Click"/>
                                        </div>
                                    </div>
